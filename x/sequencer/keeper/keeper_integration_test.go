	...
	for j := 0; j < 3; j++ {
		...
		for i := 0; i < 10; i++ {
			...
			sequencerExpect := types.Sequencer{
				...
				FuryintPubKey:     sequencerMsg.GetFuryintPubKey(),
				RollappId:        rollappId,
