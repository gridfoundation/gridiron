...
// source: gridiron/sequencer/operating_status.proto
...
func init() {
	proto.RegisterEnum("gridfoundation.gridiron.sequencer.OperatingStatus", OperatingStatus_name, OperatingStatus_value)
}

func init() {
	proto.RegisterFile("gridiron/sequencer/operating_status.proto", fileDescriptor_406c52b8df3dd90f)
}
