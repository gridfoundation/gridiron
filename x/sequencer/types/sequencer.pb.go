...
// source: gridiron/sequencer/sequencer.proto
...
func init() {
	proto.RegisterType((*Sequencer)(nil), "gridfoundation.gridiron.sequencer.Sequencer")
}

func init() {
	proto.RegisterFile("gridiron/sequencer/sequencer.proto", fileDescriptor_17d99b644bf09274)
}
