...
// source: gridiron/sequencer/description.proto
...
func init() {
	proto.RegisterType((*Description)(nil), "gridfoundation.gridiron.sequencer.Description")
}

func init() {
	proto.RegisterFile("gridiron/sequencer/description.proto", fileDescriptor_91de4c32465eb7e7)
}
