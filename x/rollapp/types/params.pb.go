...
// source: gridiron/rollapp/params.proto
...
func init() {
	proto.RegisterType((*DeployerParams)(nil), "gridfoundation.gridiron.rollapp.DeployerParams")
	proto.RegisterType((*Params)(nil), "gridfoundation.gridiron.rollapp.Params")
}

func init() { proto.RegisterFile("gridiron/rollapp/params.proto", fileDescriptor_8a5e294b0dff70d2) }
