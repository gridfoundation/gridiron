...
// source: gridiron/rollapp/tx.proto
...
import (
	context "context"
	fmt "fmt"
	types "github.com/gridfoundation/gridiron/shared/types"
...
func init() {
	proto.RegisterType((*MsgCreateRollapp)(nil), "gridfoundation.gridiron.rollapp.MsgCreateRollapp")
	proto.RegisterType((*MsgCreateRollappResponse)(nil), "gridfoundation.gridiron.rollapp.MsgCreateRollappResponse")
	proto.RegisterType((*MsgUpdateState)(nil), "gridfoundation.gridiron.rollapp.MsgUpdateState")
	proto.RegisterType((*MsgUpdateStateResponse)(nil), "gridfoundation.gridiron.rollapp.MsgUpdateStateResponse")
}

func init() { proto.RegisterFile("gridiron/rollapp/tx.proto", fileDescriptor_935cc363af28220c) }
...
func (c *msgClient) CreateRollapp(ctx context.Context, in *MsgCreateRollapp, opts ...grpc.CallOption) (*MsgCreateRollappResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gridfoundation.gridiron.rollapp.Msg/CreateRollapp", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *msgClient) UpdateState(ctx context.Context, in *MsgUpdateState, opts ...grpc.CallOption) (*MsgUpdateStateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/gridfoundation.gridiron.rollapp.Msg/UpdateState", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Msg_CreateRollapp_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gridfoundation.gridiron.rollapp.Msg/CreateRollapp",
	}
...
func _Msg_UpdateState_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/gridfoundation.gridiron.rollapp.Msg/UpdateState",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _Msg_serviceDesc = grpc.ServiceDesc{
	ServiceName: "gridfoundation.gridiron.rollapp.Msg",
	...
	Metadata: "gridiron/rollapp/tx.proto",
}
