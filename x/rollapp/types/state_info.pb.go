...
// source: gridiron/rollapp/state_info.proto
...
type StateInfo struct {
	...
	Status StateStatus `protobuf:"varint,8,opt,name=status,proto3,enum=gridfoundation.gridiron.rollapp.StateStatus" json:"status,omitempty"`
...
func init() {
	proto.RegisterType((*StateInfoIndex)(nil), "gridfoundation.gridiron.rollapp.StateInfoIndex")
	proto.RegisterType((*StateInfo)(nil), "gridfoundation.gridiron.rollapp.StateInfo")
	proto.RegisterType((*BlockHeightToFinalizationQueue)(nil), "gridfoundation.gridiron.rollapp.BlockHeightToFinalizationQueue")
}

func init() {
	proto.RegisterFile("gridiron/rollapp/state_info.proto", fileDescriptor_17fce0215a9cbbfb)
}
