...
// source: gridiron/rollapp/genesis.proto
...
func init() {
	proto.RegisterType((*GenesisState)(nil), "gridfoundation.gridiron.rollapp.GenesisState")
}

func init() { proto.RegisterFile("gridiron/rollapp/genesis.proto", fileDescriptor_f4bf6d3c28914609) }
