...
// source: gridiron/rollapp/rollapp.proto
...
func init() {
	proto.RegisterType((*Rollapp)(nil), "gridfoundation.gridiron.rollapp.Rollapp")
}

func init() { proto.RegisterFile("gridiron/rollapp/rollapp.proto", fileDescriptor_2c072320fdc0abd9) }
