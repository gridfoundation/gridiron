...
// source: gridiron/rollapp/block_descriptor.proto
...
func init() {
	proto.RegisterType((*BlockDescriptor)(nil), "gridfoundation.gridiron.rollapp.BlockDescriptor")
	proto.RegisterType((*BlockDescriptors)(nil), "gridfoundation.gridiron.rollapp.BlockDescriptors")
}

func init() {
	proto.RegisterFile("gridiron/rollapp/block_descriptor.proto", fileDescriptor_9e537259fa860c20)
}
