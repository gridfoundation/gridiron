...
// source: gridiron/rollapp/state_status.proto
...
func init() {
	proto.RegisterEnum("gridfoundation.gridiron.rollapp.StateStatus", StateStatus_name, StateStatus_value)
}

func init() {
	proto.RegisterFile("gridiron/rollapp/state_status.proto", fileDescriptor_b039e93a8767dffd)
}
