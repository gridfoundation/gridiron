...
// source: gridiron/irc/irc_requests.proto
...
type IRCRequest struct {
	...
	MessageType MsgType `protobuf:"varint,3,opt,name=message_type,json=messageType,proto3,enum=gridfoundation.gridiron.irc.MsgType" json:"message_type,omitempty"`
}
...
func init() {
	proto.RegisterEnum("gridfoundation.gridiron.irc.MsgType", MsgType_name, MsgType_value)
	proto.RegisterType((*IRCRequest)(nil), "gridfoundation.gridiron.irc.IRCRequest")
}

func init() { proto.RegisterFile("gridiron/irc/irc_requests.proto", fileDescriptor_174363cdec923693) }
