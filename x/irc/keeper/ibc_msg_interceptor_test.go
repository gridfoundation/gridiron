...
import (
	...
	keeper "github.com/gridfoundation/gridiron/x/irc/keeper"
	rollappkeeper "github.com/gridfoundation/gridiron/x/rollapp/keeper"
...
func TestIRCMessageInterceptorNotFuryCHain(t *testing.T) {
	var (
		rollappKeeper *rollappkeeper.Keeper
		keeper        *keeper.Keeper
	...
	tests := []struct {
		...
		{
			"client type is not furyint but the chain is a rollapp", func() {
