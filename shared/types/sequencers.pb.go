...
// source: gridiron/shared/sequencers.proto
...
func init() {
	proto.RegisterType((*Sequencers)(nil), "gridfoundation.gridiron.shared.Sequencers")
}

func init() { proto.RegisterFile("gridiron/shared/sequencers.proto", fileDescriptor_158b57dbfae0ceeb) }
